...
class IndividualNewMessage extends StatefulWidget {
  const IndividualNewMessage({super.key, required this.chatId});

  final String chatId;

  @override
  State<IndividualNewMessage> createState() => _NewMessage();
}

class _NewMessage extends State<IndividualNewMessage> {
